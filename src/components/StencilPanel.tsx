  ...
  return (
    <div className="flex flex-col h-full bg-gray-950 rounded-lg overflow-hidden">
      <div className="px-4 py-2 border-b border-gray-700">
        <h2 className="text-sm font-bold text-cyan-400 flex items-center gap-1.5"><Icon name="grid-square" size={13} /> Diskretisierungsstern</h2>
      </div>
        ...
        <div className="bg-gray-800 p-3 rounded space-y-1">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className={Math.abs(stencil.aW + stencil.aP + stencil.aE - 1) < 1e-10
              ...
              {Math.abs(stencil.aW + stencil.aP + stencil.aE - 1) < 1e-10 ? ' OK' : ' !!'}
            </span>
          </div>
        </div>
