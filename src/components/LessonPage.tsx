...
/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   ...
   Left  half: Learning steps (theory) — scrollable
   Right half: Interactive sandbox (simulation) — fixed
   Bottom bar: fixed navigation (outside scroll), spacebar-friendly
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
...
export default function LessonPage({ lessonId, onBack, onNavigate, onComplete }: Props) {
  ...
  // Spacebar → next lesson (only when no interactive simulation present)
  useEffect(() => {
    if (hasInteractive) return; // let SimulationContext / sandbox handle spacebar
  ...
  }, [hasInteractive, next, onNavigate]);
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div
          ...
          className={`overflow-y-auto py-10 px-8 ${
            hasInteractive ? 'w-[420px] shrink-0 border-r border-gray-800/50' : 'flex-1 max-w-2xl mx-auto'
          }`}
        >
          {/* Title */}
          <div className="mb-8">
